...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#64a0a0] via-[#5a9090] to-[#64a0a0] text-white relative overflow-hidden">
      {/* Background com gradiente da marca */}
      <div 
        className="absolute inset-0 opacity-10"
        style={{
          background: `
            radial-gradient(ellipse 60% 40% at 20% 20%, rgba(255, 255, 255, 0.2), transparent 50%),
            radial-gradient(ellipse 50% 30% at 80% 80%, rgba(255, 255, 255, 0.15), transparent 50%),
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 pt-20 pb-8 relative z-10">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/90 mb-6 leading-relaxed" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0">
            ...
            <div className="flex space-x-4" data-aos="fade-up" data-aos-delay="200" data-aos-offset="0">
              {/* Instagram */}
              <a href="https://www.instagram.com/acustikaaparelhosauditivos/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-600 transition-all duration-300 transform hover:scale-110">
                <i className="fab fa-instagram text-white text-lg"></i>
              </a>
              
              {/* Facebook */}
              <a href="https://www.facebook.com/acustikaaparelhosauditivos/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all duration-300 transform hover:scale-110">
              ...
              {/* E-mail */}
              <a href="mailto:acustikaauditiva@gmail.com" className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center hover:bg-red-500 transition-all duration-300 transform hover:scale-110">
          ...
          {/* Links Rápidos */}
          <div className="border-l border-white/20 pl-8" data-aos="fade-up" data-aos-delay="100">
            <h3 className="text-xl font-semibold mb-6 text-white">Links Rápidos</h3>
            <ul className="space-y-3">
              <li><Link to="/" className="text-white/90 hover:text-white transition-colors block">Home</Link></li>
              <li><Link to="/sobre" className="text-white/90 hover:text-white transition-colors block">Sobre Nós</Link></li>
          ...
          {/* Serviços */}
          <div className="border-l border-white/20 pl-8" data-aos="fade-up" data-aos-delay="200">
          ...
          {/* Contato */}
          <div className="border-l border-white/20 pl-8" data-aos="fade-up" data-aos-delay="300">
            <h3 className="text-xl font-semibold mb-6 text-white">Contato</h3>
            <div className="space-y-4 text-white/90">
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-1 bg-white/20">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <span className="leading-relaxed">Av. Nazaré, 1139 – Loja 2 – Térreo<br />Ed. Cardeal Hummes - Ipiranga - São Paulo/SP</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>acustikaauditiva@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/20 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center" data-aos="fade-up" data-aos-offset="0" data-aos-duration="600">
          <p className="text-white/90 text-sm">
            © 2025 Acustika. Todos os direitos reservados. Desenvolvido com <span className="inline-block animate-heartbeat" style={{color: '#dc2626'}}>❤️</span> por <a href="https://artnaweb.com.br" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 transition-colors hover:underline">ArtnaWEB</a>
          </p>
          <div className="flex space-x-8 mt-4 md:mt-0">
            <button 
              onClick={() => setIsPrivacyOpen(true)}
              className="text-white/90 hover:text-white text-sm transition-colors hover:underline"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="text-sm text-gray-600">
              ...
              <strong>Contato:</strong> acustikaauditiva@gmail.com
            </p>
          </div>
        </div>
      </Modal>
