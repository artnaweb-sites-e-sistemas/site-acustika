      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Aparelho auditivo com tecnologia avançada e design moderno, desenvolvido para oferecer uma experiência auditiva superior.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Tecnologias avançadas que tornam o Oticon Intent uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>
                Reduz ruídos de fundo automaticamente, permitindo que você se concentre nos sons importantes.
              </p>
            </div>
          </div>
        </div>
              ...
              {aparelhos.slice(0, 3).map((outroAparelho, index) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="mt-4">
                      <Link 
                        to={`/aparelho/${outroAparelho.nome.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '').replace(/['"]/g, '').replace(/[^a-z0-9]+/g, '-').replace(/^-+|-+$/g, '')}`}
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'Noto Serif, serif', fontWeight: '500', fontSize: '48px', lineHeight: '1.2' }}>
              Pronto para experimentar o Oticon Intent?
            </h2>
