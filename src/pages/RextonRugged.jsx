...
const RextonRugged = () => {
  ...
  const aparelhos = [
    ...
    },
    {
      id: 4,
      nome: "Rexton Rugged",
      descricao: "Aparelho auditivo robusto e resistente, ideal para estilos de vida ativos e desafiadores.",
      imagem: rextonRugged,
      categoria: "Resistente"
    }
  ];

  const aparelho = aparelhos.find(a => a.nome === "Rexton Rugged");
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Nosso aparelho auditivo mais resistente, projetado para suportar todos os choques e respingos da vida cotidiana. Recarregável e super compacto para um ajuste discreto.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Rexton Rugged uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Carcaça reforçada e selada para maior resistência. Pode suportar todos os choques e respingos da vida cotidiana.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Até 39 horas de autonomia sem streaming e até 36 horas com 5 horas de streaming. Recarregável para maior comodidade.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Processamento binaural avançado, adaptação ultrarrápida e tecnologia patenteada de preservação de fala.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Modelo</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>BiCore B-Li Rugged</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Alimentação</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Recarregável</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Autonomia</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Até 39h</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Streaming</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>iOS/Android</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Resistência</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Máxima</span>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Rexton Rugged?
            </h2>
            <p 
            ...
            >
              Agende um teste gratuito e descubra como este aparelho resistente pode transformar sua experiência auditiva. Estamos prontos para receber você.
            </p>
