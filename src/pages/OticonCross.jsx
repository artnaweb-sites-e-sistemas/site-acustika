        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Solução CROS</span>
            </div>
            ...
            >
              Solução CROS para perda auditiva unilateral. Transmite sons do lado sem audição para o ouvido que ouve, proporcionando uma experiência auditiva completa.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Tecnologias avançadas para perda auditiva unilateral
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>
                Transmite sons do lado sem audição para o ouvido que ouve, permitindo que você ouça de ambos os lados.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>
                Se conecta sem fio com smartphones modernos para streaming de áudio e chamadas telefônicas.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>
                Processamento de som inteligente que melhora a clareza e reduz ruídos de fundo.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-right">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Aplicação</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Perda Unilateral</span>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'Noto Serif, serif', fontWeight: '500', fontSize: '48px', lineHeight: '1.2' }}>
              Pronto para experimentar o Oticon Cross?
            </h2>
