...
const OticonReal = () => {
  ...
  const aparelhos = [
    ...
    },
    {
      id: 4,
      nome: "Oticon Real",
      descricao: "Modelo discreto e recarregável que resgata os sons reais da vida usando tecnologia BrainHearing.",
      imagem: oticonReal,
      categoria: "Recarregável"
    }
  ];

  const aparelho = aparelhos.find(a => a.nome === "Oticon Real");
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Modelo discreto e recarregável que resgata os sons reais da vida usando tecnologia BrainHearing que fornece suporte à maneira como o seu cérebro trabalha naturalmente.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Oticon Real uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Apoia seu cérebro fornecendo acesso a todos os sons relevantes ao seu redor, diferente dos aparelhos auditivos tradicionais.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Tecnologia sem fio Bluetooth® para hands-free communication e conectividade perfeita com seus dispositivos favoritos.
              </p>
            </div>
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Recarregável com Telecoil
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Modelo discreto e recarregável com telecoil e fácil controle com botão de pressão duplo para máxima praticidade.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>miniRITE R</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Telecoil</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Sim</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Controle</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Botão duplo</span>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Oticon Real?
            </h2>
            <p 
