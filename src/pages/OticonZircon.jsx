      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Aparelho auditivo recarregável pequeno e discreto com conectividade Bluetooth® para iPhone® e Android™, oferecendo acesso à fala em 360° e experiência musical incrível.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Oticon Zircon uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              >
                Acesso à fala em 360°
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Este aparelho auditivo fornece acesso à fala em 360°, mesmo em situações ruidosas, garantindo que você não perca nenhuma conversa importante.
              </p>
            </div>
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Consciência facilitada
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                A tecnologia facilita que o ouvinte fique ciente do que está acontecendo ao seu redor, mantendo-o sempre conectado ao ambiente.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Para lhe oferecer uma qualidade sonora incrível, esteja você ouvindo música ao vivo ou streaming, criamos um programa dedicado chamado Oticon MyMusic.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Made for iPhone + Android ASHA</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Bateria</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Íons de Lítio Recarregável</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Controles</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Telebobina + Botão Duplo</span>
                </div>
            ...
            >
              <div className="text-center">
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Karla, sans-serif' }}
                >
                  Recarregável pequeno e discreto
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Oticon Zircon?
            </h2>
            <p 
