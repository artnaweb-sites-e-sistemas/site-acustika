...
const RextonMCoreR = () => {
  ...
  const aparelho = aparelhos.find(a => a.nome === "Rexton M-Core R");
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Nosso modelo mais popular, agora com a tecnologia Motion Core que reconhece automaticamente o ambiente e se adapta às mais diversas situações.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Rexton M-Core R uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Tecnologia Motion Core
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Reconhece automaticamente o ambiente e se adapta às mais diversas situações, garantindo que você ouça a fala de forma mais clara.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Construído para durar, com design prático e fácil de usar, oferecendo confiabilidade em qualquer situação do dia a dia.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Bateria recarregável de longa duração, eliminando a necessidade de trocar pilhas constantemente e oferecendo praticidade total.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Motion Core</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Receptor</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>No Canal</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Adaptação</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Automática</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Durabilidade</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Alta</span>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Rexton M-Core R?
            </h2>
            <p 
