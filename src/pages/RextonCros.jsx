...
// Imports das imagens
import rextonStellar from '../assets/images/hearing-aids/produtos-rexton-stellar-04.jpg.webp';
...
// Imports dos acessórios Cros
import rextonApp from '../assets/images/hearing-aids/produtos-rexton-stellar-01-1.jpg.webp';
import smartTransmitter from '../assets/images/hearing-aids/produtos-rexton-stellar-02.jpg.webp';
import smartMic from '../assets/images/hearing-aids/produtos-rexton-stellar-03.jpg.webp';
...
const RextonCros = () => {
  ...
  const aparelhos = [
    ...
    },
    {
      id: 4,
      nome: "Rexton Cros",
      descricao: "Solução sem fio CROS para pessoas com audição normal em uma orelha e perda auditiva total na outra.",
      imagem: rextonStellar,
      categoria: "Sistema CROS"
    }
  ];

  const aparelho = aparelhos.find(a => a.nome === "Rexton Cros");
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Solução sem fio CROS indicada para pessoas com audição normal em uma orelha e perda auditiva total na outra, proporcionando percepção espacial natural.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Rexton Cros uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Percepção Espacial Natural
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Consegue ter a percepção espacial de um ouvinte normal, facilitando a escuta em qualquer tipo de ambiente e evitando a sensação de falta de localização.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Minimiza situações de desconforto para se concentrar em palestras, manter conversas em locais barulhentos ou bate-papos com vários amigos.
              </p>
            </div>
            ...
            >
              ...
              <p 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Permite reconhecer em qual lado está o interlocutor principal, resolvendo uma das maiores queixas de quem sofre com perda auditiva unilateral.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Acessórios que facilitam o dia a dia e permitem novas experiências
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="text-center mb-6">
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Karla, sans-serif' }}
                >
                  O Rexton App está disponível tanto para iPhone quanto para Android. É seu companheiro multifuncional para controlar o volume, mudar programas, padrões de microfone etc.
                </p>
              </div>
            </div>
            ...
            >
              <div className="text-center mb-6">
                <img 
                  src={smartTransmitter} 
                  alt="Smart Transmitter 2.4" 
                  className="w-full max-w-xs mx-auto mb-4"
                />
                <h3 
                  className="text-xl font-semibold text-gray-900 mb-3"
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Karla, sans-serif' }}
                >
                  Um dispositivo versátil para conectar a TV a seus aparelhos auditivos, transmitindo o som diretamente para os dispositivos MyCore com qualidade sonora Dolby Digital.
                </p>
              </div>
            </div>
            ...
            >
              <div className="text-center mb-6">
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Karla, sans-serif' }}
                >
                  Um pequeno microfone remoto Bluetooth® que transmite a voz do interlocutor diretamente aos aparelhos MyCore. Pode ser utilizado como controle remoto.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Sistema</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>CROS</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Indicação</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Anacusia</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Tecnologia</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Sem fio</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Percepção</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Espacial</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Compatibilidade</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>App e Acessórios</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Localização</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Interlocutor</span>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Rexton Cros?
            </h2>
            <p 
            ...
            >
              Agende um teste gratuito e descubra como este sistema pode transformar sua experiência auditiva. Estamos prontos para receber você.
            </p>
