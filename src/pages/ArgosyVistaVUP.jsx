        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Ultra Power</span>
            </div>
            ...
            >
              Aparelho auditivo BTE Ultra Power com bateria convencional 675 e conectividade direta Bluetooth. Ajusta-se automaticamente ao ambiente sonoro, aprimorando os sons desejados e minimizando ruídos de fundo.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Tecnologias avançadas que tornam o Argosy Vista V UP uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>
                Bateria convencional 675 de longa duração, ideal para uso contínuo durante todo o dia.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-right">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>BTE Ultra Power</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Bateria</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>675</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'Noto Serif, serif', fontWeight: '500', fontSize: '48px', lineHeight: '1.2' }}>
              Pronto para experimentar o Argosy Vista V UP?
            </h2>
