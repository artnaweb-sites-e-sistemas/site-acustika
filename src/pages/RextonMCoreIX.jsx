...
const RextonMCoreIX = () => {
  ...
  const aparelho = aparelhos.find(a => a.nome === "Rexton M-Core iX");
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8" style={{ paddingTop: '50px' }}>
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              O modelo possui design praticamente invisível com a comprovada tecnologia MotionCore, que reconhece e se adapta automaticamente a até 10 vezes mais situações auditivas.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              Descubra as tecnologias avançadas que tornam o Rexton M-Core iX uma escolha excepcional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Design Praticamente Invisível
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Design discreto que se adapta perfeitamente ao canal auditivo, tornando-o praticamente imperceptível durante o uso.
              </p>
            </div>
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Tecnologia MotionCore
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Reconhece e se adapta automaticamente a até 10 vezes mais situações auditivas, garantindo clareza de fala superior.
              </p>
            </div>
            ...
            >
              ...
              <h3 
                ...
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Experiência Sonora de Alta Qualidade
              </h3>
              <p 
                className="text-gray-600"
                style={{ fontFamily: 'Karla, sans-serif' }}
              >
                Adaptabilidade inteligente às diferentes situações assegura uma experiência sonora de alta qualidade em qualquer ambiente.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Processamento de Sinal</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Binaural, Adaptação instantânea</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Nível de Performance</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>80, 60, 40</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Canais</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>24, 32 ou 48</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Cores</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>2 cores disponíveis</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Tipo de alimentação</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>Bateria 10</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Tipo</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>CIC</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600" style={{ fontFamily: 'Karla, sans-serif' }}>Ganho/Saída Máxima</span>
                  <span className="font-semibold text-gray-900" style={{ fontFamily: 'Karla, sans-serif' }}>60/125</span>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 relative" style={{ zIndex: 10 }}>
          ...
          >
            ...
            >
              Pronto para experimentar o Rexton M-Core iX?
            </h2>
            <p 
            ...
            >
              Garanta seu aparelho Rexton M-CORE iX com a Essencial Aparelhos Auditivos e garanta o melhor preço e atendimento, com acompanhamento vitalício de uma equipe que ama o que faz.
            </p>
